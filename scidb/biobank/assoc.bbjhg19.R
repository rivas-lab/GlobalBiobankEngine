...
directory <- "/opt/biobankengine/GlobalBioBankEngineRepo/gbe_data/bbj-20190822"
pattern <- paste0(
  "BBJ\\.([a-zA-Z0-9_]+)\\.imp\\.PHENO1\\.glm\\.",
